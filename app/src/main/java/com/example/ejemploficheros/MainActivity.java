...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (comprobarPermisos()){
                    ...
                    if (sdDisponible()) {
                        ...
                        Toast.makeText(MainActivity.this,"Tarjeta NO lista para poder leer",Toast.LENGTH_SHORT).show();
                }
                else {
                    solicitarPermiso(
                            Manifest.permission.WRITE_EXTERNAL_STORAGE,
    ...
    public void leerFichero (View view){
        try{
            ...
            while (linea!=null){
                texto=texto+linea+"\n";
                Log.i("Ficheros", linea);linea=fin.readLine();
            }
            fin.close();
    ...
    public void leerRecurso(View view){
        try {InputStream fraw =getResources().openRawResource(R.raw.prueba_raw);
            BufferedReader brin =new BufferedReader( new InputStreamReader(fraw));
            String texto="";
            String linea= brin.readLine();
            while (linea!=null){
                texto=texto+linea+"\n";
                Log.i("Ficheros", linea);linea=brin.readLine();
            }
            fraw.close();
            tvContenidoFichero.setText(texto);
        }catch (Exception ex) {
    ...
    private void escribirEnSD (){
        try {File ruta_sd = Environment.getExternalStorageDirectory();
            ...
            osw.write("Primeralinea en fichero de prueba en memoria externa (Tarjeta SD)\n");
